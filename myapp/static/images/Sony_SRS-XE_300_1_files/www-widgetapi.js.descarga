...
function ya(a){a.m=0;var b=a.j.Sa;a.j=null;return b}
...
lc&&(kc=lc?lc[1]:"");if(ec){var mc=ic();if(null!=mc&&mc>parseFloat(kc)){jc=String(mc);break a}}jc=kc}var nc=jc,oc;if(z.document&&ec){var pc=ic();oc=pc?pc:parseInt(nc,10)||void 0}else oc=void 0;var qc=oc;var rc=bc()||F("iPod"),sc=F("iPad");!F("Android")||Mb();Mb();var tc=F("Safari")&&!(Mb()||F("Coast")||F("Opera")||F("Edge")||F("Edg/")||F("OPR")||F("Firefox")||F("FxiOS")||F("Silk")||F("Android"))&&!(bc()||F("iPad")||F("iPod"));var vc={},wc=null;function xc(a,b){Pa(a);void 0===b&&(b=0);yc();b=vc[b];for(var c=Array(Math.floor(a.length/3)),d=b[64]||"",e=0,f=0;e<a.length-2;e+=3){var g=a[e],h=a[e+1],k=a[e+2],l=b[g>>2];g=b[(g&3)<<4|h>>4];h=b[(h&15)<<2|k>>6];k=b[k&63];c[f++]=""+l+g+h+k}l=0;k=d;switch(a.length-e){case 2:l=a[e+1],k=b[(l&15)<<2]||d;case 1:a=a[e],c[f]=""+b[a>>2]+b[(a&3)<<4|l>>4]+k+d}return c.join("")}
...
function G(a){var b;Hc?b=a[Hc]:b=a.O;return null==b?0:b}
...
var Vc,Wc,Xc=[];Kc(Xc,23);Wc=Object.freeze(Xc);function Yc(a){if(Mc(a.v))throw Error("Cannot mutate an immutable Message");}
...
;function cd(a){switch(typeof a){case "number":return isFinite(a)?a:String(a);case "object":if(a)if(Array.isArray(a)){if(0!==(G(a)&128))return a=Array.prototype.slice.call(a),Zc(a),a}else{if(Cc(a))return xc(a);if(a instanceof Gc){var b=a.na;return null==b?"":"string"===typeof b?b:a.na=xc(b)}}}return a}
...
function ed(a,b,c,d){var e=G(a);d=d?!!(e&16):void 0;a=Array.prototype.slice.call(a);for(var f=0;f<a.length;f++)a[f]=dd(a[f],b,c,d);c(e,a);return a}
...
function ld(a,b){a&&Mc(b.v)&&Mc(a.v);return a}
function md(a,b,c,d,e){var f=jd(a,b,d);Array.isArray(f)||(f=Wc);var g=G(f);g&1||Lc(f);if(e)g&2||Ic(f,2),c&1||Object.freeze(f);else{e=!(c&2);var h=g&2;c&1||!h?e&&g&16&&!h&&Jc(f,16):(f=Lc(Array.prototype.slice.call(f)),kd(a,b,f,d))}return f}
...
function pd(a,b,c){var d=void 0===d?!1:d;var e=jd(a,c,d);var f=!1;var g=null==e||"object"!==typeof e||(f=Array.isArray(e))||e.za!==Tc?f?new b(e):void 0:e;g!==e&&null!=g&&(kd(a,c,g,d),Ic(g.v,G(a.v)&18));b=ld(g,a);if(null==b)return b;Mc(a.v)||(e=qd(b),e!==b&&(b=e,kd(a,c,b,d)));return ld(b,a)}
function rd(a,b,c,d,e,f){a.h||(a.h={});var g=a.h[c],h=md(a,c,3,d,f);if(g)f||(Object.isFrozen(g)?e||(g=Array.prototype.slice.call(g),a.h[c]=g):e&&Object.freeze(g));else{g=[];var k=!!(G(a.v)&16),l=Mc(h);!f&&l&&(h=Lc(Array.prototype.slice.call(h)),kd(a,c,h,d));d=l;for(var m=0;m<h.length;m++){var n=h[m];var r=b;var q=k,x=!1;x=void 0===x?!1:x;q=void 0===q?!1:q;r=Array.isArray(n)?new r(q?Qc(n):n):x?new r:void 0;void 0!==r&&(d=d||Mc(n),g.push(r),l&&Ic(r.v,2))}a.h[c]=g;a=h;b=!d;Object.isFrozen(a)||(c=G(a)|
33,Kc(a,b?c|8:c&-9));(f||e&&l)&&Ic(g,2);(f||e)&&Object.freeze(g)}return g}
...
function td(a,b,c,d,e){Yc(a);if(null!=d){var f=Lc([]);for(var g=!1,h=0;h<d.length;h++)f[h]=bd(d[h],b).v,g=g||Mc(f[h]);a.h||(a.h={});a.h[c]=d;b=f;g?Jc(b,8):Ic(b,8)}else a.h&&(a.h[c]=void 0),f=Wc;return kd(a,c,f,e)}
function ud(a,b,c,d){Yc(a);var e=rd(a,c,b,void 0,!1,!1);c=null!=d?bd(d,c):new c;a=md(a,b,2,void 0,!1);e.push(c);a.push(c.v);Mc(c.v)&&Jc(a,8)}
function vd(a,b){return jd(a,b)}
function wd(a,b){a=jd(a,b);return null==a?"":a}
;function xd(a,b,c){c=void 0===c?Sc:c;if(null!=a){if(Bc&&a instanceof Uint8Array)return a.length?new Gc(new Uint8Array(a)):Ec||(Ec=new Gc(null));if(Array.isArray(a)){var d=G(a);if(d&2)return a;if(b&&!(d&32)&&(d&16||0===d))return Kc(a,d|2),a;a=ed(a,xd,c,!0);b=G(a);b&4&&b&2&&Object.freeze(a);return a}return a.za===Tc?yd(a):a}}
function zd(a,b,c,d,e,f,g){(a=a.h&&a.h[c])?(d=0<a.length?a[0].constructor:void 0,f=G(a),f&2||(a=db(a,yd),Sc(f,a),Object.freeze(a)),td(b,d,c,a,e)):I(b,c,xd(d,f,g),e)}
function yd(a){if(Mc(a.v))return a;a=Ad(a,!0);Ic(a.v,2);return a}
function Ad(a,b){var c=a.v,d=Qc([]),e=a.constructor.h;e&&d.push(e);a.I&&(d.length=c.length,d.fill(void 0,d.length,c.length),d[d.length-1]={});0!==(G(c)&128)&&Zc(d);b=b||Mc(a.v)?Sc:Rc;e=a.constructor;G(d);$c=d;d=new e(d);$c=void 0;a.ja&&(d.ja=a.ja.slice());e=!!(G(c)&16);for(var f=0;f<c.length;f++){var g=c[f];if(f===c.length-1&&Uc(g))for(var h in g){var k=+h;Number.isNaN(k)?id(d)[k]=g[k]:zd(a,d,k,g[h],!0,e,b)}else zd(a,d,f-a.X,g,!1,e,b)}return d}
...
function qd(a){if(Mc(a.v)){var b=Ad(a,!1);b.j=a;a=b}return a}
function Bd(a,b){if(Array.isArray(a)){var c=G(a),d=1;!b||c&2||(d|=16);(c&d)!==d&&Kc(a,c|d)}}
L.prototype.za=Tc;L.prototype.toString=function(){return this.v.toString()};
function Dd(a,b){return cd(b)}
function Ed(a,b){b.ja&&(a.ja=b.ja.slice());var c=b.h;if(c){b=b.I;for(var d in c){var e=c[d];if(e){var f=!(!b||!b[d]),g=+d;if(Array.isArray(e)){if(e.length){var h=a,k=e[0].constructor,l=Mc(h.v);k=rd(h,k,g,f,l,l);f=md(h,g,3,f,l);if(!(l||G(f)&8)){for(l=0;l<k.length;l++)g=k[l],h=qd(g),g!==h&&(k[l]=h,f[l]=k[l].v);Ic(f,8)}for(l=0;l<Math.min(k.length,e.length);l++)Ed(k[l],e[l])}}else throw Error("unexpected object: type: "+Oa(e)+": "+e);}}}}
...
;function Kd(a){var b=C("window.location.href");null==a&&(a='Unknown Error of type "null/undefined"');if("string"===typeof a)return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c=!1;try{var d=a.lineNumber||a.line||"Not available"}catch(g){d="Not available",c=!0}try{var e=a.fileName||a.filename||a.sourceURL||z.$googDebugFname||b}catch(g){e="Not available",c=!0}b=Ld(a);if(!(!c&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name)){c=a.message;if(null==
...
function Vd(a){var b=void 0===b?Td:b;return Ud(a,b)||Kb}
...
function be(){var a=ce(),b={};E(ae(),function(c){a.sandbox&&a.sandbox.supports&&a.sandbox.supports(c)&&(b[c]=!0)});
return b}
...
;function he(a,b,c){var d=String(z.location.href);return d&&a&&b?[b,ie(ee(d),a,c||null)].join(" "):null}
function ie(a,b,c){var d=[],e=[];if(1==(Array.isArray(c)?2:1))return e=[b,a],E(d,function(h){e.push(h)}),je(e.join(" "));
...
p=le.prototype;p.isEnabled=function(){if(!z.navigator.cookieEnabled)return!1;if(!this.ya())return!0;this.set("TESTCOOKIESENABLED","1",{Ja:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
...
function oe(a,b,c,d){(a=z[a])||(a=(new le(document)).get(b));return a?he(a,c,d):null}
function pe(a){var b=void 0===b?!1:b;var c=ee(String(z.location.href)),d=[];var e=b;e=void 0===e?!1:e;var f=z.__SAPISID||z.__APISID||z.__3PSAPISID||z.__OVERRIDE_SID;ne(e)&&(f=f||z.__1PSAPISID);if(f)e=!0;else{var g=new le(document);f=g.get("SAPISID")||g.get("APISID")||g.get("__Secure-3PAPISID")||g.get("SID");ne(e)&&(f=f||g.get("__Secure-1PAPISID"));e=!!f}e&&(e=(c=0==c.indexOf("https:")||0==c.indexOf("chrome-extension:")||0==c.indexOf("moz-extension:"))?z.__SAPISID:z.__APISID,e||(e=new le(document),
...
D(te,re);var ue={2:"touch",3:"pen",4:"mouse"};
...
D(Qe,qe);Qe.prototype[ve]=!0;Qe.prototype.addEventListener=function(a,b,c,d){Fe(this,a,b,c,d)};
...
var c,d;this.i=null!=(d=null==(c=window.navigator)?void 0:c.onLine)?d:!0;this.m=function(){return y(function(e){return w(e,Ue(b),0)})};
...
function Ve(a){a.H=a.K.M(function(){var b;return y(function(c){if(1==c.h)return a.i?(null==(b=window.navigator)?0:b.onLine)?c.s(3):w(c,Ue(a),3):w(c,Ue(a),3);Ve(a);c.h=0})},3E4)}
function Ue(a,b){return a.u?a.u:a.u=new Promise(function(c){var d,e,f,g;return y(function(h){switch(h.h){case 1:return d=window.AbortController?new window.AbortController:void 0,f=null==(e=d)?void 0:e.signal,g=!1,wa(h,2,3),d&&(a.l=a.K.M(function(){d.abort()},b||2E4)),w(h,fetch("/generate_204",{method:"HEAD",
signal:f}),5);case 5:g=!0;case 3:Aa(h);a.u=void 0;a.l&&(a.K.aa(a.l),a.l=0);g!==a.i&&(a.i=g,a.i?Re(a,"networkstatus-online"):Re(a,"networkstatus-offline"));c(g);Ba(h);break;case 2:ya(h),g=!1,h.s(3)}})})}
...
;var uf;function vf(){var a=z.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!F("Presto")&&(a=function(){var e=Id();e.style.display="none";document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=Wa(function(k){if(("*"==h||k.origin==h)&&k.data==g)this.port1.onmessage()},this);
f.addEventListener("message",e,!1);this.port1={};this.port2={postMessage:function(){f.postMessage(g,h)}}});
if("undefined"!==typeof a&&!F("Trident")&&!F("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var e=c.Qa;c.Qa=null;e()}};
...
"function"!==typeof z.setImmediate||z.Window&&z.Window.prototype&&!F("Edge")&&z.Window.prototype.setImmediate==z.setImmediate?(uf||(uf=vf()),uf(b)):z.setImmediate(b)}}
...
D(If,Hf);If.prototype.reset=function(){this.h[0]=1732584193;this.h[1]=4023233417;this.h[2]=2562383102;this.h[3]=271733878;this.h[4]=3285377520;this.l=this.i=0};
...
;function Yf(a){this.h=0;this.u=void 0;this.l=this.i=this.j=null;this.o=this.m=!1;if(a!=ab)try{var b=this;a.call(void 0,function(c){Zf(b,2,c)},function(c){Zf(b,3,c)})}catch(c){Zf(this,3,c)}}
...
Yf.prototype.then=function(a,b,c){return zg(this,"function"===typeof a?a:null,"function"===typeof b?b:null,c)};
Yf.prototype.$goog_Thenable=!0;Yf.prototype.cancel=function(a){if(0==this.h){var b=new Ag(a);Cf(function(){Bg(this,b)},this)}};
function Bg(a,b){if(0==a.h)if(a.j){var c=a.j;if(c.i){for(var d=0,e=null,f=null,g=c.i;g&&(g.l||(d++,g.h==a&&(e=g),!(e&&1<d)));g=g.next)e||(f=g);e&&(0==c.h&&1==d?Bg(c,b):(f?(d=f,d.next==c.l&&(c.l=d),d.next=d.next.next):Cg(c),Dg(c,e,3,b)))}a.j=null}else Zf(a,3,b)}
function Eg(a,b){a.i||2!=a.h&&3!=a.h||Fg(a);a.l?a.l.next=b:a.i=b;a.l=b}
function zg(a,b,c,d){var e=yg(null,null,null);e.h=new Yf(function(f,g){e.j=b?function(h){try{var k=b.call(d,h);f(k)}catch(l){g(l)}}:f;
e.i=c?function(h){try{var k=c.call(d,h);void 0===k&&h instanceof Ag?g(h):f(k)}catch(l){g(l)}}:g});
e.h.j=a;Eg(a,e);return e.h}
Yf.prototype.H=function(a){this.h=0;Zf(this,2,a)};
Yf.prototype.W=function(a){this.h=0;Zf(this,3,a)};
function Zf(a,b,c){if(0==a.h){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.h=1;a:{var d=c,e=a.H,f=a.W;if(d instanceof Yf){Eg(d,yg(e||ab,f||null,a));var g=!0}else{if(d)try{var h=!!d.$goog_Thenable}catch(l){h=!1}else h=!1;if(h)d.then(e,f,a),g=!0;else{if(Qa(d))try{var k=d.then;if("function"===typeof k){Gg(d,k,e,f,a);g=!0;break a}}catch(l){f.call(a,l);g=!0;break a}g=!1}}}g||(a.u=c,a.h=b,a.j=null,Fg(a),3!=b||c instanceof Ag||Hg(a,c))}}
...
Yf.prototype.C=function(){for(var a;a=Cg(this);)Dg(this,a,this.h,this.u);this.m=!1};
...
D(Ag,Ya);Ag.prototype.name="cancel";function N(a){qe.call(this);this.u=1;this.l=[];this.m=0;this.h=[];this.i={};this.C=!!a}
D(N,qe);p=N.prototype;p.subscribe=function(a,b,c){var d=this.i[a];d||(d=this.i[a]=[]);var e=this.u;this.h[e]=a;this.h[e+1]=b;this.h[e+2]=c;this.u=e+3;d.push(e);return e};
...
D(Og,Ng);function Pg(a){this.data=a}
...
D(Rg,Og);Rg.prototype.set=function(a,b,c){if(b=Qg(b)){if(c){if(c<Date.now()){Rg.prototype.remove.call(this,a);return}b.expiration=c}b.creation=Date.now()}Rg.R.set.call(this,a,b)};
...
;function Tg(){}
D(Tg,Sg);Tg.prototype[Symbol.iterator]=function(){return Nf(this.L(!0)).h()};
...
D(Ug,Tg);p=Ug.prototype;p.set=function(a,b){try{this.h.setItem(a,b)}catch(c){if(0==this.h.length)throw"Storage mechanism: Storage disabled";throw"Storage mechanism: Quota exceeded";}};
...
D(ah,Tg);ah.prototype.set=function(a,b){this.i.set(this.h+a,b)};
...
v(Ph,L);var Qh=[3];var Rh=z.window,Sh,Th,Uh=(null==Rh?void 0:null==(Sh=Rh.yt)?void 0:Sh.config_)||(null==Rh?void 0:null==(Th=Rh.ytcfg)?void 0:Th.data_)||{};B("yt.config_",Uh);function Vh(){var a=arguments;1<a.length?Uh[a[0]]=a[1]:1===a.length&&Object.assign(Uh,a[0])}
...
hi.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var lb=z.ytEventsEventsListeners||{};B("ytEventsEventsListeners",lb);var ji=z.ytEventsEventsCounter||{count:0};B("ytEventsEventsCounter",ji);
...
function li(a){a&&("string"==typeof a&&(a=[a]),E(a,function(b){if(b in lb){var c=lb[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?mi()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete lb[b]}}))}
...
var ui=String(si);function vi(a){var b=[];jb(a,function(c,d){var e=encodeURIComponent(String(d)),f;Array.isArray(c)?f=c:f=[c];E(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
...
(n=Fd.screen)?void 0:n.availWidth;var r;e.u_cd=null==(r=Fd.screen)?void 0:r.colorDepth}catch(W){}h=b.h;try{var q=h.screenX;var x=h.screenY}catch(W){}try{var A=h.outerWidth;var H=h.outerHeight}catch(W){}try{var K=h.innerWidth;var M=h.innerHeight}catch(W){}try{var O=h.screenLeft;var ob=h.screenTop}catch(W){}try{K=h.innerWidth,M=h.innerHeight}catch(W){}try{var uc=h.screen.availWidth;var za=h.screen.availTop}catch(W){}q=[O,ob,q,x,uc,za,A,H,K,M];x=b.h.top;try{var ra=(x||window).document,X="CSS1Compat"==
ra.compatMode?ra.documentElement:ra.body;var ca=(new Hd(X.clientWidth,X.clientHeight)).round()}catch(W){ca=new Hd(-12245933,-12245933)}ra=ca;ca={};var da=void 0===da?z:da;X=new Ye;da.SVGElement&&da.document.createElementNS&&X.set(0);x=be();x["allow-top-navigation-by-user-activation"]&&X.set(1);x["allow-popups-to-escape-sandbox"]&&X.set(2);da.crypto&&da.crypto.subtle&&X.set(3);da.TextDecoder&&da.TextEncoder&&X.set(4);da=Ze(X);ca.bc=da;ca.bih=ra.height;ca.biw=ra.width;ca.brdim=q.join();b=b.i;b=(ca.vis=
...
B("yt.ads_.signals_.getAdSignalsString",function(a){return vi(zi(a))});Date.now();var Bi="XMLHttpRequest"in z?function(){return new XMLHttpRequest}:null;
...
d=b.timeout||0;if(b.onTimeout&&0<d){var g=b.onTimeout;var h=oi(function(){e||(e=!0,f.abort(),window.clearTimeout(h),g.call(b.context||z,f))},d)}}
...
function Mi(a,b,c,d){var e=null;switch(b){case "JSON":try{var f=c.responseText}catch(g){throw d=Error("Error reading responseText"),d.params=a,bi(d),g;}a=c.getResponseHeader("Content-Type")||"";f&&0<=a.indexOf("json")&&(")]}'\n"===f.substring(0,5)&&(f=f.substring(5)),e=JSON.parse(f));break;case "XML":if(a=(a=c.responseXML)?Ni(a):null)e={},E(a.getElementsByTagName("*"),function(g){e[g.tagName]=Oi(g)})}d&&Pi(e);
return e}
function Pi(a){if(Qa(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;tb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax");var d=a[b];if(void 0===rb){var e=null;var f=z.trustedTypes;if(f&&f.createPolicy){try{e=f.createPolicy("goog#html",{createHTML:Xa,createScript:Xa,createScriptURL:Xa})}catch(g){z.console&&z.console.error(g.message)}rb=e}else rb=e}d=(e=rb)?e.createHTML(d):d;a[c]=new Ob(d)}else Pi(a[b])}}
function Ni(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function Oi(a){var b="";E(a.childNodes,function(c){b+=c.nodeValue});
return b}
...
function V(a,b,c,d){var e,f,g,h,k,l,m,n,r,q,x,A;return y(function(H){switch(H.h){case 1:var K={mode:"readonly",G:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?K.mode=c:Object.assign(K,c);e=K;a.transactionCount++;f=e.G?3:1;g=0;case 2:if(h){H.s(3);break}g++;k=Math.round(U());wa(H,4);l=a.h.transaction(b,e.mode);K=new Qk(l);K=Rk(K,d);return w(H,K,6);case 6:return m=H.i,n=Math.round(U()),Sk(a,k,n,g,void 0,b.join(),e),H.return(m);case 4:r=ya(H);q=Math.round(U());x=Jj(r,a.h.name,b.join(),a.h.version);
if((A=x instanceof T&&!x.h)||g>=f)Sk(a,k,q,g,x,b.join(),e),h=x;H.s(2);break;case 3:return H.return(Promise.reject(h))}})}
...
function cl(a,b){b=void 0===b?{}:b;var c,d,e,f;return y(function(g){if(1==g.h)return wa(g,2),c=self.indexedDB.deleteDatabase(a),d=b,(e=d.kb)&&c.addEventListener("blocked",function(){e()}),w(g,Uj(c),4);
if(2!=g.h)return xa(g,0);f=ya(g);throw Jj(f,a,"",-1);})}
...
function hl(a){function b(){var f,g,h,k,l,m,n,r,q,x;return y(function(A){switch(A.h){case 1:return g=null!=(f=Error().stack)?f:"",wa(A,2),w(A,a.j(a.name,a.options.version,d),4);case 4:h=A.i;for(var H=a.options,K=[],M=u(Object.keys(H.ea)),O=M.next();!O.done;O=M.next()){O=O.value;var ob=H.ea[O],uc=void 0===ob.Bb?Number.MAX_VALUE:ob.Bb;!(h.h.version>=ob.ha)||h.h.version>=uc||h.h.objectStoreNames.contains(O)||K.push(O)}k=K;if(0===k.length){A.s(5);break}l=Object.keys(a.options.ea);m=h.objectStoreNames();
if(a.m<di("ytidb_reopen_db_retries",0))return a.m++,h.close(),wj(new T("DB_REOPENED_BY_MISSING_OBJECT_STORES",{dbName:a.name,expectedObjectStores:l,foundObjectStores:m})),A.return(b());if(!(a.o<di("ytidb_remake_db_retries",1))){A.s(6);break}a.o++;if(!R("ytidb_remake_db_enable_backoff_delay")){A.s(7);break}return w(A,dl(a.i),8);case 8:a.i*=2;case 7:return w(A,a.delete(),9);case 9:return wj(new T("DB_DELETED_BY_MISSING_OBJECT_STORES",{dbName:a.name,expectedObjectStores:l,foundObjectStores:m})),A.return(b());
case 6:throw new Gj(m,l);case 5:return A.return(h);case 2:n=ya(A);if(n instanceof DOMException?"VersionError"!==n.name:"DOMError"in self&&n instanceof DOMError?"VersionError"!==n.name:!(n instanceof Object&&"message"in n)||"An attempt was made to open a database using a lower version than the existing version."!==n.message){A.s(10);break}return w(A,a.j(a.name,void 0,Object.assign({},d,{upgrade:void 0})),11);case 11:r=A.i;q=r.h.version;if(void 0!==a.options.version&&q>a.options.version+1)throw r.close(),
a.l=!1,fl(a,q);return A.return(r);case 10:throw c(),n instanceof Error&&!R("ytidb_async_stack_killswitch")&&(n.stack=n.stack+"\n"+g.substring(g.indexOf("\n")+1)),Jj(n,a.name,"",null!=(x=a.options.version)?x:-1);}})}
...
function jl(a,b){var c;return y(function(d){if(1==d.h)return w(d,gl(il,b),2);c=d.i;return d.return(V(c,["databases"],{G:!0,mode:"readwrite"},function(e){var f=e.objectStore("databases");return f.get(a.actualName).then(function(g){if(g?a.actualName!==g.actualName||a.publicName!==g.publicName||a.userIdentifier!==g.userIdentifier:1)return Vj(f.h.put(a,void 0)).then(function(){})})}))})}
function kl(a,b){var c;return y(function(d){if(1==d.h)return a?w(d,gl(il,b),2):d.return();c=d.i;return d.return(c.delete("databases",a))})}
function ll(a,b){var c,d;return y(function(e){return 1==e.h?(c=[],w(e,gl(il,b),2)):3!=e.h?(d=e.i,w(e,V(d,["databases"],{G:!0,mode:"readonly"},function(f){c.length=0;return Wk(f.objectStore("databases"),{},function(g){a(g.N())&&c.push(g.N());return g.continue()})}),3)):e.return(c)})}
...
wa(e,2);d={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return w(e,jl(d,ol),4);case 4:return w(e,kl("yt-idb-test-do-not-use",ol),5);case 5:return e.return(!0);case 2:return ya(e),e.return(!1)}})}
...
function ul(a,b,c,d){var e,f,g,h,k,l;return y(function(m){switch(m.h){case 1:return f=null!=(e=Error().stack)?e:"",w(m,sl(),2);case 2:g=m.i;if(!g)throw h=Kj("openDbImpl",a,b),R("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),wj(h),h;yj(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:tl(a);wa(m,3);return w(m,jl(k,g),5);case 5:return w(m,bl(k.actualName,b,d),6);case 6:return m.return(m.i);case 3:return l=ya(m),wa(m,7),w(m,kl(k.actualName,g),9);case 9:xa(m,
...
function xl(a,b){b=void 0===b?{}:b;var c,d;return y(function(e){if(1==e.h)return w(e,sl(),2);if(3!=e.h){c=e.i;if(!c)return e.return();yj(a);d=tl(a);return w(e,cl(d.actualName,b),3)}return w(e,kl(d.actualName,c),0)})}
function yl(a,b,c){a=a.map(function(d){return y(function(e){return 1==e.h?w(e,cl(d.actualName,b),2):w(e,kl(d.actualName,c),0)})});
return Promise.all(a).then(function(){})}
function zl(){var a=void 0===a?{}:a;var b,c;return y(function(d){if(1==d.h)return w(d,sl(),2);if(3!=d.h){b=d.i;if(!b)return d.return();yj("LogsDatabaseV2");return w(d,ml(b),3)}c=d.i;return w(d,yl(c,a,b),0)})}
function Al(a,b){b=void 0===b?{}:b;var c;return y(function(d){if(1==d.h)return w(d,sl(),2);if(3!=d.h){c=d.i;if(!c)return d.return();yj(a);return w(d,cl(a,b),3)}return w(d,kl(a,c),0)})}
...
function Hl(a,b,c){var d,e,f;return y(function(g){switch(g.h){case 1:return d={config:a,hashData:b,timestamp:U()},w(g,Gl(c),2);case 2:return e=g.i,w(g,e.clear("hotConfigStore"),3);case 3:return w(g,Pk(e,"hotConfigStore",d),4);case 4:return f=g.i,g.return(f)}})}
function Il(a,b,c,d){var e,f,g;return y(function(h){switch(h.h){case 1:return e={config:a,hashData:b,configData:c,timestamp:U()},w(h,Gl(d),2);case 2:return f=h.i,w(h,f.clear("coldConfigStore"),3);case 3:return w(h,Pk(f,"coldConfigStore",e),4);case 4:return g=h.i,h.return(g)}})}
function Jl(a){var b,c;return y(function(d){return 1==d.h?w(d,Gl(a),2):3!=d.h?(b=d.i,c=void 0,w(d,V(b,["coldConfigStore"],{mode:"readwrite",G:!0},function(e){return Zk(e.objectStore("coldConfigStore").index("coldTimestampIndex"),{direction:"prev"},function(f){c=f.N()})}),3)):d.return(c)})}
function Kl(a){var b,c;return y(function(d){return 1==d.h?w(d,Gl(a),2):3!=d.h?(b=d.i,c=void 0,w(d,V(b,["hotConfigStore"],{mode:"readwrite",G:!0},function(e){return Zk(e.objectStore("hotConfigStore").index("hotTimestampIndex"),{direction:"prev"},function(f){c=f.N()})}),3)):d.return(c)})}
;function Ll(){}
function Ml(a,b,c){var d,e,f;return y(function(g){if(1==g.h){if(!R("gcf_config_store_update_enabled"))return g.s(0);c&&(a.h=c,B("yt.gcf.config.hotConfigGroup",a.h));a.hotHashData=b;B("yt.gcf.config.hotHashData",a.hotHashData);return(d=rl())?c?g.s(4):w(g,Kl(d),5):g.s(0)}4!=g.h&&(e=g.i,c=null==(f=e)?void 0:f.config);return w(g,Hl(c,b,d),0)})}
function Nl(a,b,c){var d,e,f,g;return y(function(h){if(1==h.h){if(!R("gcf_config_store_update_enabled"))return h.s(0);a.coldHashData=b;B("yt.gcf.config.coldHashData",a.coldHashData);return(d=rl())?c?h.s(4):w(h,Jl(d),5):h.s(0)}4!=h.h&&(e=h.i,c=null==(f=e)?void 0:f.config);if(!c)return h.s(0);g=c.configData;return w(h,Il(c,b,g,d),0)})}
...
function Ql(a){var b={client:{hl:a.Xa,gl:a.Wa,clientName:a.Ua,clientVersion:a.Va,configInfo:a.Ia}};navigator.userAgent&&(b.client.userAgent=String(navigator.userAgent));var c=z.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=P("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=ei();0<c.length&&(b.request={internalExperimentFlags:c});Rl(a,void 0,b);R("enable_third_party_info")&&Sl(void 0,b);Tl(void 0,b);Ul(a,void 0,b);Vl(void 0,b);R("start_sending_config_hash")&&Wl(void 0,
...
function Tl(a,b){var c;if(R("web_log_memory_total_kbytes")&&(null==(c=z.navigator)?0:c.deviceMemory)){var d;c=null==(d=z.navigator)?void 0:d.deviceMemory;a?I(a,95,1E6*c):b&&(b.client.memoryTotalKbytes=""+1E6*c)}}
...
this.da=function(){};
this.now=Date.now;this.ia=!1;var b;this.gb=null!=(b=a.gb)?b:100;var c;this.fb=null!=(c=a.fb)?c:1;var d;this.cb=null!=(d=a.cb)?d:2592E6;var e;this.bb=null!=(e=a.bb)?e:12E4;var f;this.eb=null!=(f=a.eb)?f:5E3;var g;this.A=null!=(g=a.A)?g:void 0;this.wa=!!a.wa;var h;this.va=null!=(h=a.va)?h:.1;var k;this.Ba=null!=(k=a.Ba)?k:10;a.handleError&&(this.handleError=a.handleError);a.da&&(this.da=a.da);a.ia&&(this.ia=a.ia);a.ra&&(this.ra=a.ra);this.B=a.B;this.K=a.K;this.D=a.D;this.F=a.F;this.S=a.S;this.Ma=a.Ma;
this.La=a.La;gm(this)&&(!this.B||this.B("networkless_logging"))&&hm(this)}
function hm(a){gm(a)&&!a.ia&&(a.h=!0,a.wa&&Math.random()<=a.va&&a.D.nb(a.A),im(a),a.F.J()&&a.la(),a.F.Y(a.Ma,a.la.bind(a)),a.F.Y(a.La,a.Pa.bind(a)))}
p=fm.prototype;p.writeThenSend=function(a,b){var c=this;b=void 0===b?{}:b;if(gm(this)&&this.h){var d={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0};this.D.set(d,this.A).then(function(e){d.id=e;c.F.J()&&jm(c,d)}).catch(function(e){jm(c,d);
km(c,e)})}else this.S(a,b)};
p.sendThenWrite=function(a,b,c){var d=this;b=void 0===b?{}:b;if(gm(this)&&this.h){var e={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0};this.B&&this.B("nwl_skip_retry")&&(e.skipRetry=c);if(this.F.J()||this.B&&this.B("nwl_aggressive_send_then_write")&&!e.skipRetry){if(!e.skipRetry){var f=b.onError?b.onError:function(){};
b.onError=function(g,h){return y(function(k){if(1==k.h)return w(k,d.D.set(e,d.A).catch(function(l){km(d,l)}),2);
f(g,h);k.h=0})}}this.S(a,b,e.skipRetry)}else this.D.set(e,this.A).catch(function(g){d.S(a,b,e.skipRetry);
km(d,g)})}else this.S(a,b,this.B&&this.B("nwl_skip_retry")&&c)};
...
d.options.onSuccess=function(g,h){void 0!==d.id?c.D.ba(d.id,c.A):e=!0;c.F.Z&&c.B&&c.B("vss_network_hint")&&c.F.Z(!0);f(g,h)};
this.S(d.url,d.options);this.D.set(d,this.A).then(function(g){d.id=g;e&&c.D.ba(d.id,c.A)}).catch(function(g){km(c,g)})}else this.S(a,b)};
p.la=function(){var a=this;if(!gm(this))throw Kj("throttleSend");this.i||(this.i=this.K.M(function(){var b;return y(function(c){if(1==c.h)return w(c,a.D.Ta("NEW",a.A),2);if(3!=c.h)return b=c.i,b?w(c,jm(a,b),3):(a.Pa(),c.return());a.i&&(a.i=0,a.la());c.h=0})},this.gb))};
p.Pa=function(){this.K.aa(this.i);this.i=0};
function jm(a,b){var c,d;return y(function(e){switch(e.h){case 1:if(!gm(a))throw c=Kj("immediateSend"),c;if(void 0===b.id){e.s(2);break}return w(e,a.D.zb(b.id,a.A),3);case 3:(d=e.i)?b=d:a.da(Error("The request cannot be found in the database."));case 2:if(lm(a,b,a.cb)){e.s(4);break}a.da(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.s(5);break}return w(e,a.D.ba(b.id,a.A),5);case 5:return e.return();case 4:b.skipRetry||(b=mm(a,b));if(!b){e.s(0);break}if(!b.skipRetry||
void 0===b.id){e.s(8);break}return w(e,a.D.ba(b.id,a.A),8);case 8:a.S(b.url,b.options,!!b.skipRetry),e.h=0}})}
function mm(a,b){if(!gm(a))throw Kj("updateRequestHandlers");var c=b.options.onError?b.options.onError:function(){};
b.options.onError=function(e,f){var g,h,k;return y(function(l){switch(l.h){case 1:g=nm(f);if(!(a.B&&a.B("nwl_consider_error_code")&&g||a.B&&!a.B("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.Ba)){l.s(2);break}if(!a.F.Da){l.s(3);break}return w(l,a.F.Da(),3);case 3:if(a.F.J()){l.s(2);break}c(e,f);if(!a.B||!a.B("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){l.s(6);break}return w(l,a.D.Na(b.id,a.A,!1),6);case 6:return l.return();case 2:if(a.B&&a.B("nwl_consider_error_code")&&
!g&&a.potentialEsfErrorCounter>a.Ba)return l.return();a.potentialEsfErrorCounter++;if(void 0===(null==(k=b)?void 0:k.id)){l.s(8);break}return b.sendCount<a.fb?w(l,a.D.Na(b.id,a.A),12):w(l,a.D.ba(b.id,a.A),8);case 12:a.K.M(function(){a.F.J()&&a.la()},a.eb);
case 8:c(e,f),l.h=0}})};
var d=b.options.onSuccess?b.options.onSuccess:function(){};
b.options.onSuccess=function(e,f){var g;return y(function(h){if(1==h.h)return void 0===(null==(g=b)?void 0:g.id)?h.s(2):w(h,a.D.ba(b.id,a.A),2);a.F.Z&&a.B&&a.B("vss_network_hint")&&a.F.Z(!0);d(e,f);h.h=0})};
return b}
function lm(a,b,c){b=b.timestamp;return a.now()-b>=c?!1:!0}
function im(a){if(!gm(a))throw Kj("retryQueuedRequests");a.D.Ta("QUEUED",a.A).then(function(b){b&&!lm(a,b,a.bb)?a.K.M(function(){return y(function(c){if(1==c.h)return void 0===b.id?c.s(2):w(c,a.D.Na(b.id,a.A),2);im(a);c.h=0})}):a.F.J()&&a.la()})}
function km(a,b){a.hb&&!a.F.J()?a.hb(b):a.handleError(b)}
function gm(a){return!!a.A||a.ra}
...
function sm(a,b){var c,d,e,f;return y(function(g){if(1==g.h)return c={startTime:U(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},w(g,rm(b),2);if(3!=g.h)return d=g.i,e=Object.assign({},a,{options:JSON.parse(JSON.stringify(a.options)),interface:P("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),w(g,Pk(d,"LogsRequestsStore",e),3);f=g.i;c.Db=U();tm(c);return g.return(f)})}
function um(a,b){var c,d,e,f,g,h,k;return y(function(l){if(1==l.h)return c={startTime:U(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},w(l,rm(b),2);if(3!=l.h)return d=l.i,e=P("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=[a,e,0],g=[a,e,U()],h=IDBKeyRange.bound(f,g),k=void 0,w(l,V(d,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(m){return Zk(m.objectStore("LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(n){n.N()&&(k=n.N(),"NEW"===a&&(k.status="QUEUED",n.update(k)))})}),
3);
c.Db=U();tm(c);return l.return(k)})}
function vm(a,b){var c;return y(function(d){if(1==d.h)return w(d,rm(b),2);c=d.i;return d.return(V(c,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(e){var f=e.objectStore("LogsRequestsStore");return f.get(a).then(function(g){if(g)return g.status="QUEUED",Vj(f.h.put(g,void 0)).then(function(){return g})})}))})}
function wm(a,b,c){c=void 0===c?!0:c;var d;return y(function(e){if(1==e.h)return w(e,rm(b),2);d=e.i;return e.return(V(d,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(f){var g=f.objectStore("LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",c&&(h.sendCount+=1),Vj(g.h.put(h,void 0)).then(function(){return h})):Oj.resolve(void 0)})}))})}
function xm(a,b){var c;return y(function(d){if(1==d.h)return w(d,rm(b),2);c=d.i;return d.return(c.delete("LogsRequestsStore",a))})}
function ym(a){var b,c;return y(function(d){if(1==d.h)return w(d,rm(a),2);b=d.i;c=U()-2592E6;return w(d,V(b,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(e){return Wk(e.objectStore("LogsRequestsStore"),{},function(f){if(f.N().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
function zm(){y(function(a){return w(a,zl(),0)})}
...
function Dm(a){var b,c;y(function(d){if(1==d.h)return w(d,Cm(a),2);b=d.i;c=U()-2592E6;return w(d,V(b,["SWHealthLog"],{mode:"readwrite",G:!0},function(e){return Wk(e.objectStore("SWHealthLog"),{},function(f){if(f.N().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
function Em(a){var b;return y(function(c){if(1==c.h)return w(c,Cm(a),2);b=c.i;return w(c,b.clear("SWHealthLog"),0)})}
...
;var Pm;function Qm(){var a=fm.call;Pm||(Pm=new Nm({dc:!0,cc:!0}));a.call(fm,this,{D:{nb:ym,ba:xm,Ta:um,zb:vm,Na:wm,set:sm},F:Pm,handleError:ai,da:bi,S:Rm,now:U,hb:Lm,K:nj(),Ma:"publicytnetworkstatus-online",La:"publicytnetworkstatus-offline",wa:!0,va:.1,Ba:di("potential_esf_error_limit",10),B:R,ia:!(pj()&&"www.youtube-nocookie.com"!==Rb(document.location.toString()))});this.j=new Xf;R("networkless_immediately_drop_all_requests")&&zm();Al("LogsDatabaseV2")}
v(Qm,fm);function Sm(){var a=C("yt.networklessRequestController.instance");a||(a=new Qm,B("yt.networklessRequestController.instance",a),R("networkless_logging")&&sl().then(function(b){a.A=b;hm(a);a.j.resolve();a.wa&&Math.random()<=a.va&&a.A&&Dm(a.A);R("networkless_immediately_drop_sw_health_store")&&Tm(a)}));
return a}
...
function Tm(a){var b;y(function(c){if(!a.A)throw b=Kj("clearSWHealthLogsDb"),b;return c.return(Em(a.A).catch(function(d){a.handleError(d)}))})}
...
;var Vm=z.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:!1};B("ytNetworklessLoggingInitializationOptions",Vm);function Wm(a){var b=this;this.config_=null;a?this.config_=a:Ol()&&(this.config_=Pl());jj(function(){dm(b)},5E3)}
Wm.prototype.isReady=function(){!this.config_&&Ol()&&(this.config_=Pl());return!!this.config_};
function em(a,b,c,d){function e(x){x=void 0===x?!1:x;var A;if(d.retry&&"www.youtube-nocookie.com"!=h&&(x||R("skip_ls_gel_retry")||"application/json"!==g.headers["Content-Type"]||(A=bm(b,c,l,k)),A)){var H=g.onSuccess,K=g.onFetchSuccess;g.onSuccess=function(M,O){cm(A);H(M,O)};
c.onFetchSuccess=function(M,O){cm(A);K(M,O)}}try{x&&d.retry&&!d.Za.bypassNetworkless?(g.method="POST",d.Za.writeThenSend?Sm().writeThenSend(q,g):Sm().sendAndWrite(q,g)):R("web_all_payloads_via_jspb")?Ii(q,g):(g.method="POST",g.postParams||(g.postParams={}),Ii(q,g))}catch(M){if("InvalidAccessError"==M.name)A&&(cm(A),A=0),bi(Error("An extension is blocking network request."));
else throw M;}A&&jj(function(){dm(a)},5E3)}
...
D(Ym,qe);Ym.prototype.Ga=function(a){void 0===a.h&&ii(a);var b=a.h;void 0===a.i&&ii(a);this.h=new Gd(b,a.i)};
...
var wn=new vn,xn=new vn,yn,zn=!0,An=z.ytLoggingTransportGELQueue_||new Map;B("ytLoggingTransportGELQueue_",An);var Bn=z.ytLoggingTransportGELProtoQueue_||new Map;B("ytLoggingTransportGELProtoQueue_",Bn);var Cn=z.ytLoggingTransportTokensToCttTargetIds_||{};B("ytLoggingTransportTokensToCttTargetIds_",Cn);var Dn=z.ytLoggingTransportTokensToJspbCttTargetIds_||{};B("ytLoggingTransportTokensToJspbCttTargetIds_",Dn);var En={};function Fn(){var a=C("yt.logging.ims");a||(a=new nn,B("yt.logging.ims",a));return a}
...
function On(a,b){R("web_all_payloads_via_jspb")&&bi(new oj("transport.logIsolatedGelPayload called in JSPB only experiment"));if("log_event"===a.endpoint){Hn(a);var c=In(a),d=new Map;d.set(c,[a.payload]);b&&(un=new b);return new Yf(function(e,f){un&&un.isReady()?Pn(d,un,e,f,{bypassNetworkless:!0},!0):e()})}}
function Qn(a,b){if("log_event"===a.endpoint){Hn(void 0,a);var c=In(a,!0),d=new Map;d.set(c,[a.payload.toJSON()]);b&&(un=new b);return new Yf(function(e){un&&un.isReady()?Rn(d,un,e,{bypassNetworkless:!0},!0):e()})}}
...
function Wn(a){var b,c,d,e,f,g,h,k,l,m;return y(function(n){if(1==n.h){d=null==(b=a)?void 0:null==(c=b.responseContext)?void 0:c.globalConfigGroup;var r=d?d[dh.name]:void 0;e=r;g=null==(f=d)?void 0:f.hotHashData;r=d?d[ch.name]:void 0;h=r;l=null==(k=d)?void 0:k.coldHashData;mn||(mn=new jn);m=mn.resolve(Ll);return g?e?w(n,Ml(m,g,e),2):w(n,Ml(m,g),2):n.s(2)}return l?h?w(n,Nl(m,l,h),0):w(n,Nl(m,l),0):n.s(0)})}
;var co=z.ytLoggingGelSequenceIdObj_||{};B("ytLoggingGelSequenceIdObj_",co);function eo(a){Mn(void 0,void 0,void 0===a?!1:a)}
...
function Co(a,b,c){Do||(Do={},ni(window,"message",function(d){a:{if(d.origin===Bo(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=Do[e.id])d.u=!0,d.u&&(E(d.m,d.sendMessage,d),d.m.length=0),d.Oa(e)}e=void 0}return e}));
Do[c]=b}
...
b.toString());var g=a.Ra();g.enablejsapi=window.postMessage?1:0;window.location.host&&(g.origin=window.location.protocol+"//"+window.location.host);g.widgetid=a.id;window.location.href&&E(["debugjs","debugcss"],function(k){var l=$b(window.location.href,k);null!==l&&(g[k]=l)});
var h=""+Bo(a.i,"host")+("/embed/"+Bo(a.i,"videoId"))+"?"+Yb(g);Eo.yt_embedsEnableUaChProbe?ro().then(function(k){var l=new URL(h),m=Number(l.searchParams.get("reloads"));isNaN(m)&&(m=0);l.searchParams.set("reloads",(m+1).toString());k&&l.searchParams.set("uach",k);l.searchParams.set("uats",Math.floor(window.performance.timeOrigin).toString());k=Ud(l.href).toString();Qd(c,Vd(k));return k}):Eo.yt_embedsEnableIframeSrcWithIntent?Qd(c,Vd(h)):c.src=h;
return c}
...
h;if(f){f.hasOwnProperty("level")&&f.level&&(h=f.level);if(R("console_log_js_exceptions")){var k=f,l=[];l.push("Name: "+k.name);l.push("Message: "+k.message);k.hasOwnProperty("params")&&l.push("Error Params: "+JSON.stringify(k.params));k.hasOwnProperty("args")&&l.push("Error args: "+JSON.stringify(k.args));l.push("File name: "+k.fileName);l.push("Stacktrace: "+k.stack);window.console.log(l.join("\n"),k)}if(!(5<=lo)){var m=void 0,n=void 0,r=f,q=g,x=Kd(r),A=x.message||"Unknown Error",H=x.name||"UnknownError",
K=x.stack||r.i||"Not available";if(K.startsWith(H+": "+A)){var M=K.split("\n");M.shift();K=M.join("\n")}var O=x.lineNumber||"Not available",ob=x.fileName||"Not available",uc=K,za=0;if(r.hasOwnProperty("args")&&r.args&&r.args.length)for(var ra=0;ra<r.args.length&&!(za=$i(r.args[ra],"params."+ra,q,za),500<=za);ra++);else if(r.hasOwnProperty("params")&&r.params){var X=r.params;if("object"===typeof r.params)for(n in X){if(X[n]){var ca="params."+n,da=bj(X[n]);q[ca]=da;za+=ca.length+da.length;if(500<za)break}}else q.params=
bj(X)}if(oo.length)for(var W=0;W<oo.length&&!(za=$i(oo[W],"params.context."+W,q,za),500<=za);W++);navigator.vendor&&!q.hasOwnProperty("vendor")&&(q["device.vendor"]=navigator.vendor);var S={message:A,name:H,lineNumber:O,fileName:ob,stack:uc,params:q,sampleWeight:1},bk=Number(r.columnNumber);isNaN(bk)||(S.lineNumber=S.lineNumber+":"+bk);if("IGNORED"===r.level)m=0;else a:{for(var ck=Wi(),dk=u(ck.U),$f=dk.next();!$f.done;$f=dk.next()){var ek=$f.value;if(S.message&&S.message.match(ek.ec)){m=ek.weight;
break a}}for(var fk=u(ck.T),ag=fk.next();!ag.done;ag=fk.next()){var gk=ag.value;if(gk.mb(S)){m=gk.weight;break a}}m=1}S.sampleWeight=m;for(var hk=u(Ri),bg=hk.next();!bg.done;bg=hk.next()){var cg=bg.value;if(cg.Aa[S.name])for(var ik=u(cg.Aa[S.name]),dg=ik.next();!dg.done;dg=ik.next()){var jk=dg.value,Wd=S.message.match(jk.regexp);if(Wd){S.params["params.error.original"]=Wd[0];for(var eg=jk.groups,kk={},Vb=0;Vb<eg.length;Vb++)kk[eg[Vb]]=Wd[Vb+1],S.params["params.error."+eg[Vb]]=Wd[Vb+1];S.message=cg.Ka(kk);
break}}}S.params||(S.params={});var lk=Wi();S.params["params.errorServiceSignature"]="msg="+lk.U.length+"&cb="+lk.T.length;S.params["params.serviceWorker"]="false";z.document&&z.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));tb("sample").constructor!==sb&&(S.params["params.fconst"]="true");var ua=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(ua);if(0!==ua.sampleWeight&&!ko.has(ua.message)){if("ERROR"===h){Xi.fa("handleError",
ua);if(R("record_app_crashed_web")&&0===no&&1===ua.sampleWeight)if(no++,R("errors_via_jspb")){var fg=new Hh;I(fg,1,1);if(!R("report_client_error_with_app_crash_ks")){var mk=new Ch;I(mk,1,ua.message);var nk=new Dh;J(nk,Ch,3,mk);var ok=new Eh;J(ok,Dh,5,nk);var pk=new Fh;J(pk,Eh,9,ok);J(fg,Fh,4,pk)}var Ro=fg,qk=new Kh;sd(qk,Hh,20,Lh,Ro);jo(qk)}else{var rk={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};R("report_client_error_with_app_crash_ks")||(rk.systemHealth={crashData:{clientError:{logMessage:{message:ua.message}}}});
ho("appCrashed",rk)}mo++}else"WARNING"===h&&Xi.fa("handleWarning",ua);if(R("kevlar_gel_error_routing"))a:{var gg=void 0,hg=void 0,Nc=h,Q=ua;if(R("errors_via_jspb")){if(qo())hg=void 0;else{var Wb=new zh;I(Wb,1,Q.stack);Q.fileName&&I(Wb,4,Q.fileName);var Ma=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Ma.length&&(1!==Ma.length||isNaN(Number(Ma[0]))?2!==Ma.length||isNaN(Number(Ma[0]))||isNaN(Number(Ma[1]))||(I(Wb,2,Number(Ma[0])),I(Wb,3,Number(Ma[1]))):I(Wb,2,Number(Ma[0])));var vb=
new Ch;I(vb,1,Q.message);I(vb,3,Q.name);I(vb,6,Q.sampleWeight);"ERROR"===Nc?I(vb,2,2):"WARNING"===Nc?I(vb,2,1):I(vb,2,0);var ig=new Ah;I(ig,1,!0);sd(ig,zh,3,Bh,Wb);var wb=new wh;I(wb,3,window.location.href);for(var sk=P("FEXP_EXPERIMENTS",[]),jg=0;jg<sk.length;jg++){var tk=wb,So=sk[jg];Yc(tk);md(tk,5,2,!1,!1).push(So)}var kg=Wh();if(!Xh()&&kg)for(var uk=u(Object.keys(kg)),xb=uk.next();!xb.done;xb=uk.next()){var vk=xb.value,lg=new yh;I(lg,1,vk);I(lg,2,String(kg[vk]));ud(wb,4,yh,lg)}var mg=Q.params;
if(mg){var wk=u(Object.keys(mg));for(xb=wk.next();!xb.done;xb=wk.next()){var xk=xb.value,ng=new yh;I(ng,1,"client."+xk);I(ng,2,String(mg[xk]));ud(wb,4,yh,ng)}}var yk=P("SERVER_NAME"),zk=P("SERVER_VERSION");if(yk&&zk){var og=new yh;I(og,1,"server.name");I(og,2,yk);ud(wb,4,yh,og);var pg=new yh;I(pg,1,"server.version");I(pg,2,zk);ud(wb,4,yh,pg)}var Xd=new Dh;J(Xd,wh,1,wb);J(Xd,Ah,2,ig);J(Xd,Ch,3,vb);hg=Xd}var Ak=hg;if(!Ak)break a;var Bk=new Kh;sd(Bk,Dh,163,Lh,Ak);jo(Bk)}else{if(qo())gg=void 0;else{var Oc=
{stackTrace:Q.stack};Q.fileName&&(Oc.filename=Q.fileName);var Na=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Na.length&&(1!==Na.length||isNaN(Number(Na[0]))?2!==Na.length||isNaN(Number(Na[0]))||isNaN(Number(Na[1]))||(Oc.lineNumber=Number(Na[0]),Oc.columnNumber=Number(Na[1])):Oc.lineNumber=Number(Na[0]));var qg={level:"ERROR_LEVEL_UNKNOWN",message:Q.message,errorClassName:Q.name,sampleWeight:Q.sampleWeight};"ERROR"===Nc?qg.level="ERROR_LEVEL_ERROR":"WARNING"===Nc&&(qg.level="ERROR_LEVEL_WARNNING");
var To={isObfuscated:!0,browserStackInfo:Oc},Xb={pageUrl:window.location.href,kvPairs:[]};P("FEXP_EXPERIMENTS")&&(Xb.experimentIds=P("FEXP_EXPERIMENTS"));var rg=Wh();if(!Xh()&&rg)for(var Ck=u(Object.keys(rg)),yb=Ck.next();!yb.done;yb=Ck.next()){var Dk=yb.value;Xb.kvPairs.push({key:Dk,value:String(rg[Dk])})}var sg=Q.params;if(sg){var Ek=u(Object.keys(sg));for(yb=Ek.next();!yb.done;yb=Ek.next()){var Fk=yb.value;Xb.kvPairs.push({key:"client."+Fk,value:String(sg[Fk])})}}var Gk=P("SERVER_NAME"),Hk=P("SERVER_VERSION");
Gk&&Hk&&(Xb.kvPairs.push({key:"server.name",value:Gk}),Xb.kvPairs.push({key:"server.version",value:Hk}));gg={errorMetadata:Xb,stackTrace:To,logMessage:qg}}var Ik=gg;if(!Ik)break a;ho("clientError",Ik)}if("ERROR"===Nc||R("errors_flush_gel_always_killswitch"))b:{if(R("web_fp_via_jspb")&&(eo(!0),!R("web_fp_via_jspb_and_json")))break b;eo()}}if(!R("suppress_error_204_logging")){var zb=ua,Pc=zb.params||{},$a={urlParams:{a:"logerror",t:"jserror",type:zb.name,msg:zb.message.substr(0,250),line:zb.lineNumber,
level:h,"client.name":Pc.name},postParams:{url:P("PAGE_NAME",window.location.href),file:zb.fileName},method:"POST"};Pc.version&&($a["client.version"]=Pc.version);if($a.postParams){zb.stack&&($a.postParams.stack=zb.stack);for(var Jk=u(Object.keys(Pc)),tg=Jk.next();!tg.done;tg=Jk.next()){var Kk=tg.value;$a.postParams["client."+Kk]=Pc[Kk]}var ug=Wh();if(ug)for(var Lk=u(Object.keys(ug)),vg=Lk.next();!vg.done;vg=Lk.next()){var Mk=vg.value;$a.postParams[Mk]=ug[Mk]}var Nk=P("SERVER_NAME"),Ok=P("SERVER_VERSION");
...
"yt-player");h&&(f[d++]=b)}f.length=d;b=f}}b=hb(b);E(gb(a,b),Uo)});
